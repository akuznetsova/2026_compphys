...
`````{tip}
Download the in-class exercises template [here](../in-class/4a_exercises.ipynb) and the module [gaussxw.py](../in-class/gaussxw.py)
`````

## Reminders 
Class is taught by Dr. Kevin Whitley this week. 
